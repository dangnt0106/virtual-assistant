...
def check_Internet_Urllib(url="http://google.com", timeout=3):
    try:
        ...
        def stop(name):
            try:
                ...
                if 0 <= day_time < 4:
                    ...
                    speak(
                        "Hẹn gặp lại bạn {} sau!. Chúc bạn một ngày mới tốt lành.".format(name))
                elif 10 <= day_time < 13:
                    speak(
                    ...
                    speak(
                        "Hẹn gặp lại bạn {} sau!. Bạn nhớ ngủ sớm để giữ gìn sức khỏe nha. Chúc bạn ngủ ngon.".format(name))
                time.sleep(10)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
        ...
        def hello(name):
            try:
                ...
                if 0 <= day_time < 4:
                    ...
                    speak(
                        "Chào buổi sáng bạn {}. Chúc bạn một ngày mới tốt lành.".format(name))
                elif 10 <= day_time < 13:
                    speak(
                    ...
                    speak(
                        "Chào cuối ngày bạn {}. Bạn nhớ ngủ sớm để giữ gìn sức khỏe nha. Chúc bạn ngủ ngon.".format(name))
                time.sleep(10)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
            ...
            try:
                ...
                if "google" in text:
                    ...
                    if os.path.exists(f"D:\\Test\\Shortcut\\Notepad.lnk"):
                        ...
                        speak(
                            "Có thể đường dẫn của bạn không chính xác. Vui lòng xem lại!")
                        time.sleep(5)
                    ...
                    speak(
                        "Bạn có chắc chắn đã cài đặt ứng dụng này? Xin hãy kiểm tra lại!")
                    time.sleep(5)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
        ...
        def send_email():
            ...
            time.sleep(2)
            # haha 123456
            pasword = input("Tôi: Mời bạn nhập mật khẩu email: ")
        ...
        def read_news():
            try:
                ...
                speak(
                    'Dưới đây là danh sách tin tức về "{}". Lưu ý là nếu không tìm được kết quả thì sẽ không có danh sách.'.format(queue))
                time.sleep(8)
        ...
        def change_wallpaper_in_internet():
            try:
                ...
                urllib2.urlretrieve(
                    photo, f"D:\\Test\\Image\\background_test.jpg")
        ...
        def change_wallpaper_in_computer():
            try:
                speak(
                    "Bạn muốn chọn hình nào trong số những hình này để thay đổi hình nền?")
                ...
                if os.path.exists("D:\\Test\\Image\\{image}.jpg".format(image=image)):
                    ...
                    speak(
                        "Có lẽ bạn đã phát âm sai tên của hình ảnh hoặc định dạng file không phù hợp. Vui lòng thử lại sau!")
                    time.sleep(7.5)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
        ...
        def tell_me_about():
            try:
                ...
                speak(
                    "Tôi không định nghĩa được thuật ngữ của bạn. Xin mời bạn thử lại sau!")
                time.sleep(6)
        ...
        def play_song_in_computer():
            try:
                ...
                if os.path.exists(f"D:\\Test\\Music\\{mysong}.mp3"):
                    ...
                    speak(
                        "Bài hát bạn yêu cầu chưa có trong máy hoặc sai tên. Bạn hãy tải bài hát hoặc kiểm tra lại tên bài hát!")
                    time.sleep(8)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
        ...
        def search_file():
            try:
                ...
                while disk != "C" and disk != "D":
                    print(
                        "Bot: Nhập sai, mời nhập lại. Lưu ý hiện giờ tôi chỉ có thể tìm kiếm trên hai ổ đĩa C và D mà thôi.")
                    disk = str(input("Tôi: Mời nhập tên ổ đĩa: ")).upper()
                speak(
                    "Xin hãy nhập tên file bạn muốn tìm kiếm! Lưu ý hãy nhập cả đuôi file.")
                time.sleep(5)
                ...
                if count == 1:
                    ...
                    print("Bot: " + f)
                    speak(
                        "Bạn có muốn thực hiện thao tác nào khác với file vừa tìm được không?")
                    time.sleep(5)
                    action = get_text()
                    if "không" in action:
                        return
        ...
        # Cập nhật tình hình giá vàng trên thị trường.
                ...
                if (str(language1) == "việt" or str(language1) == "anh" or str(language1) == "nhật") and (str(language2) == "việt" or str(language2) == "anh" or str(language2) == "nhật"):
                    if str(language1) == str(language2):
                        ...
                        if str(language2) == "anh":
                            ...
                            time.sleep(7.5)
                            speak_japanese("{out_word}".format(
            ...
            try:
                ...
                while True:
                    ...
                    if result:
                        ...
                        return
                print(
                    "Bot: Bạn vui lòng đợi trong giây lát. Đang tiến hành tải video...")
                url = "https://www.youtube.com" + result[0]["url_suffix"]
                ...
                if os.path.exists(file):
                    speak('Đã tải xong video "{video}".'.format(
                        video=video.title()))
                    time.sleep(4)
        ...
        def create_file():
            try:
                ...
                if "txt" in file_type or "note pad" in file_type or "ghi chú" in file_type:
                    ...
                    time.sleep(5)
                    print(
                        "Bot: D:\\Test\\Test File\\{file}.txt".format(file=name))
                    os.startfile(
                        "D:\\Test\\Test File\\{file}.txt".format(file=name))
                    ...
                    document.save(
                        "D:\\Test\\Test File\\{file}.docx".format(file=name))
                    speak("Đã tạo file. Dưới đây là đường dẫn tới file bạn vừa tạo.")
                    time.sleep(5)
                    print(
                        "Bot: D:\\Test\\Test File\\{file}.docx".format(file=name))
                    os.startfile(
                        "D:\\Test\\Test File\\{file}.docx".format(file=name))
                    ...
                    time.sleep(5)
                    print(
                        "Bot: D:\\Test\\Test File\\{file}.xlsx".format(file=name))
                    os.startfile(
                        "D:\\Test\\Test File\\{file}.xlsx".format(file=name))
                    ...
                    time.sleep(5)
                    print(
                        "Bot: D:\\Test\\Test File\\{file}.pptx".format(file=name))
                    os.startfile(
                        "D:\\Test\\Test File\\{file}.pptx".format(file=name))
                else:
                    speak(
                        "Tạm thời tôi chưa thể tạo được loại file này hoặc tên loại file không chính xác. Xin hãy kiểm tra lại!")
                    time.sleep(8)
            except:
                speak("Đã xảy ra lỗi. Vui lòng thử lại sau!")
                time.sleep(4)
        ...
        def create_folder():
            try:
                ...
                speak(
                    "Tạo thư mục thành công. Dưới đây là tên đường dẫn tới thư mục bạn vừa tạo.")
                time.sleep(6)
            ...
            try:
                ...
                if count == 1:
                    ...
                    if "không" in action:
                        ...
                        print(
                            "Bot: Đường dẫn mới của thư mục sau khi đổi tên ", path + new_name)
                        time.sleep(2)
                    elif "xóa" in action:
            ...
            try:
                ...
                if "có" in answer or "chắc chắn" in answer:
                    ...
                    if "pm" == am_or_pm:
                        ...
                        speak(
                            "Bạn đã không chọn đúng giá trị am hay pm. Vui lòng thử lại sau!")
                        time.sleep(7)
                        return
                    while(1 == 1):
        ...
        def create_qrcode():
            try:
                ...
                while "https:" != path_split and "http:" != path_split:
                    print(
                        "Bot: Dường như đường dẫn của bạn không đúng. Xin mời nhập lại!")
                    input_data = input("Tôi: Mời nhập đường dẫn: ")
                    path_split = input_data.split("//")[0]
        ...
        def help_me():
            ...
            5.  Tìm kiếm từ khóa, ảnh trên trên Google.
            6.  Gửi email.
            7.  Dự báo thời tiết.
                ...
                if name:
                    ...
                    while True:
                        ...
                        if not text:
                            ...
                            speak(
                                "Bạn muốn lấy hình ngẫu nhiên trên mạng hay hình trên máy tính?")
                            time.sleep(5)
                            option = get_text()
